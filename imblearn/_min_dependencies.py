...
dependent_packages = {'numpy': (NUMPY_MIN_VERSION, 'install'), 'scipy': (SCIPY_MIN_VERSION, 'install'), 'scikit-learn': (SKLEARN_MIN_VERSION, 'install'), 'joblib': (JOBLIB_MIN_VERSION, 'install'), 'threadpoolctl': (THREADPOOLCTL_MIN_VERSION, 'install'), 'pandas': (PANDAS_MIN_VERSION, 'optional, docs, examples, tests'), 'tensorflow': (TENSORFLOW_MIN_VERSION, 'optional, docs, examples, tests'), 'keras': (KERAS_MIN_VERSION, 'optional, docs, examples, tests'), 'matplotlib': ('3.1.2', 'docs, examples'), 'seaborn': ('0.9.0', 'docs, examples'), 'memory_profiler': ('0.57.0', 'docs'), 'pytest': (PYTEST_MIN_VERSION, 'tests'), 'pytest-cov': ('2.9.0', 'tests'), 'flake8': ('3.8.2', 'tests'), 'black': ('23.3.0', 'tests'), 'mypy': ('1.3.0', 'tests'), 'sphinx': ('6.0.0', 'docs'), 'sphinx-gallery': ('0.13.0', 'docs'), 'sphinx-copybutton': ('0.5.2', 'docs'), 'numpydoc': ('1.5.0', 'docs'), 'sphinxcontrib-bibtex': ('2.4.1', 'docs'), 'pydata-sphinx-theme': ('0.13.3', 'docs'), 'sphinx-design': ('0.5.0', 'docs')}
tag_to_packages: dict = {extra: [] for extra in ['install', 'optional', 'docs', 'examples', 'tests']}
